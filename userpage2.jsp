...
<html>
    ...
    <body class="body">
        ...
        <div style="position:absolute; right:1500px; top:60px; left:200px; width: 0px; height: ">
            ...
            <form name="ff" action="u.jsp" method="get" onkeydown="AnEventHasOccurred();">
            ...
            <div style="margin-left:450px; margin-top:-20px; width: 400px;" >
                <fieldset >
                    <%
                        ...
                        ResultSet rss = sss.executeQuery("select * from cmt ORDER BY 'time' DESC ");
                        while (rss.next()) {
                    ...
                    <div style="margin-left:500px; margin-top:-20px; width: 400px;" >
                ...
                <!--  begin flow -->      
                <div style="position:absolute; right:15px; top:270px; left:0px; width: 300px; height:" >       
